...
CREATE TABLE IF NOT EXISTS `mydb`.`account` (
  ...
  UNIQUE INDEX `idBankAccount_UNIQUE` (`idAccount` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`enterprise` (
  ...
  INDEX `fk_enterprise_Account1_idx` (`idAccount` ASC),
  CONSTRAINT `fk_enterprise_Account1`
    FOREIGN KEY (`idAccount`)
    REFERENCES `mydb`.`account` (`idAccount`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
